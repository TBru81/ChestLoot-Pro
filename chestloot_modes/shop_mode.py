# ============================================================
# ChestLoot Pro - Shop Chest Standalone Test v0.2.4
# Razor Enhanced Python / UOAlive
#
# v0.2.4
# - Replaces the early-steal cooldown warning with immersive blue narration.
# - Prevents the displayed cooldown from ever reaching 0.0 seconds.
# - Removes redundant chest and theft targeting narration.
# - Applies the 16-pixel section and final-control clearance standard.
# - Corrects the final Shop Options section to a full 16-pixel panel clearance.
# - Preserves the recorded Shop Rare orange message and sound 580 alert.
#
# Manual-stealing Shop workflow. ChestMaster prepares the chest, provides a
# built-in Stealing macro, sorts successful thefts, and maintains a separate
# Shop Rare discovery journal. The player always chooses the item and risk.
#
# All Shop gump button and label coordinates are independently editable in SL.
# ============================================================
MAIN_GUMP_ID = 885100
...
# ============================================================
# GUMP LAYOUT SETTINGS - SHOP TEST BUILD
# Every visible Shop button and label has its own editable X/Y coordinate.
# Nothing in the Shop drawing functions derives a label position from its
# button position. Frames, titles, dividers, and list controls are editable too.
# ============================================================
DL = {
    # MAIN GUMP - compact two-panel ChestMaster layout.
    "main_width": 232, "main_height": 251,
    "main_outer_x": 0, "main_outer_y": 0,
    "main_title_x": 10, "main_title_y": 10, "main_title_w": 212, "main_title_h": 26,
    "main_upper_x": 16, "main_upper_y": 32, "main_upper_w": 200, "main_upper_h": 111,
    "main_lower_x": 16, "main_lower_y": 151, "main_lower_w": 200, "main_lower_h": 84,
    "mode_button_x": 26, "mode_button_y": 45, "mode_label_x": 60, "mode_label_y": 49,
    "loot_button_x": 36, "loot_button_y": 81, "loot_label_x": 60, "loot_label_y": 77,
    "options_button_x": 86, "options_button_y": 107,
    ...
    "options_width": 300, "options_height": 752,
    "options_outer_x": 0, "options_outer_y": 0,
    "options_main_x": 16, "options_main_y": 16, "options_main_w": 268, "options_main_h": 667,
    "options_footer_x": 16, "options_footer_y": 691, "options_footer_w": 268, "options_footer_h": 45,
    "options_title_x": 21, "options_title_y": 27, "options_title_w": 258, "options_title_h": 22,
    "section_x": 30, "section_divider_x": 32, "section_divider_w": 236,
    "bags_header_y": 62, "types_header_y": 190, "magic_header_y": 470,
    "recorded_header_y": 545, "trap_header_y": 612,
    "bag_button_x": 34, "bag_label_x": 58, "bag_state_x": 185,
    "valuable_bag_y": 99, "magic_bag_y": 128, "rare_bag_y": 157,
    "toggle_button_x": 34, "toggle_label_x": 68,
    "arrows_y": 230, "blank_scrolls_y": 253, "bolts_y": 276, "gems_y": 299, "gold_y": 322,
    "magic_items_y": 345, "potions_y": 368, "reagents_y": 391,
    "refinements_y": 414, "spell_scrolls_y": 437,
    "tier_button_x": 34, "tier_button_y": 515, "tier_label_x": 58, "tier_label_y": 511,
    "rares_button_x": 34, "rares_button_y": 590, "rares_label_x": 58, "rares_label_y": 586,
    "trap_button_x": 34, "trap_button_y": 651, "trap_label_x": 58, "trap_label_y": 647,
    "back_button_x": 34, "back_button_y": 702, "back_label_x": 68, "back_label_y": 704,
    # RECORDED LIST GUMPS - standard ChestMaster panel with navigation footer.
    "list_width": 460, "list_height": 447,
    "list_main_x": 16, "list_main_y": 16, "list_main_w": 428, "list_main_h": 344,
    "list_footer_x": 16, "list_footer_y": 368, "list_footer_w": 428, "list_footer_h": 63,
    "list_title_y": 28, "list_divider_x": 34, "list_divider_y": 51, "list_divider_w": 392,
    "list_empty_x": 34, "list_empty_y": 78,
    "list_row_label_x": 34, "list_row_label_y": 78,
    "list_category_label_x": 250, "list_category_label_y": 78,
    "list_row_button_x": 350, "list_row_button_y": 76,
    "list_remove_label_x": 384, "list_remove_label_y": 78, "list_row_spacing": 35,
    "list_page_x": 179, "list_page_y": 374,
    "list_back_button_x": 28, "list_back_button_y": 397, "list_back_label_x": 62, "list_back_label_y": 399,
    "list_prev_button_x": 176, "list_prev_button_y": 397, "list_prev_label_x": 210, "list_prev_label_y": 399,
    "list_next_button_x": 358, "list_next_button_y": 397, "list_next_label_x": 392, "list_next_label_y": 399,
}

SL = {
    # MAIN GUMP
    "main_width": 232, "main_height": 295,
    "main_outer_x": 0, "main_outer_y": 0,
    "main_title_x": 10, "main_title_y": 10, "main_title_w": 212, "main_title_h": 26,
    "main_upper_x": 16, "main_upper_y": 32, "main_upper_w": 200, "main_upper_h": 83,
    "main_lower_x": 16, "main_lower_y": 123, "main_lower_w": 200, "main_lower_h": 156,
    "mode_button_x": 26, "mode_button_y": 45,
    "mode_label_x": 60, "mode_label_y": 49,
    "options_button_x": 86, "options_button_y": 81,
    "learn_rare_button_x": 26, "learn_rare_button_y": 136,
    "learn_rare_label_x": 60, "learn_rare_label_y": 138,
    "learn_shop_button_x": 26, "learn_shop_button_y": 172,
    "learn_shop_label_x": 60, "learn_shop_label_y": 174,
    "steal_button_x": 26, "steal_button_y": 208,
    "steal_label_x": 60, "steal_label_y": 210,
    "target_button_x": 26, "target_button_y": 244,
    "target_label_x": 60, "target_label_y": 246,

    # OPTIONS GUMP
    "options_width": 300, "options_height": 700,
    "options_outer_x": 0, "options_outer_y": 0,
    "options_main_x": 16, "options_main_y": 16, "options_main_w": 268, "options_main_h": 615,
    "options_footer_x": 16, "options_footer_y": 639, "options_footer_w": 268, "options_footer_h": 45,
    "options_title_x": 21, "options_title_y": 27, "options_title_w": 258, "options_title_h": 22,
    "bags_header_x": 30, "bags_header_y": 62,
    "bags_divider_x": 32, "bags_divider_y": 82, "bags_divider_w": 236,
    "valuable_button_x": 34, "valuable_button_y": 103,
    "valuable_label_x": 58, "valuable_label_y": 99, "valuable_state_x": 185, "valuable_state_y": 99,
    "shop_bag_button_x": 34, "shop_bag_button_y": 132,
    "shop_bag_label_x": 58, "shop_bag_label_y": 128, "shop_bag_state_x": 185, "shop_bag_state_y": 128,
    "rare_bag_button_x": 34, "rare_bag_button_y": 161,
    "rare_bag_label_x": 58, "rare_bag_label_y": 157, "rare_bag_state_x": 185, "rare_bag_state_y": 157,
    "types_header_x": 30, "types_header_y": 190,
    "types_divider_x": 32, "types_divider_y": 210, "types_divider_w": 236,
    "equipment_button_x": 34, "equipment_button_y": 228, "equipment_label_x": 68, "equipment_label_y": 230,
    "food_button_x": 34, "food_button_y": 251, "food_label_x": 68, "food_label_y": 253,
    "gems_button_x": 34, "gems_button_y": 274, "gems_label_x": 68, "gems_label_y": 276,
    "potions_button_x": 34, "potions_button_y": 297, "potions_label_x": 68, "potions_label_y": 299,
    "reagents_button_x": 34, "reagents_button_y": 320, "reagents_label_x": 68, "reagents_label_y": 322,
    "refinements_button_x": 34, "refinements_button_y": 343, "refinements_label_x": 68, "refinements_label_y": 345,
    "resources_button_x": 34, "resources_button_y": 366, "resources_label_x": 68, "resources_label_y": 368,
    "scrolls_button_x": 34, "scrolls_button_y": 389, "scrolls_label_x": 68, "scrolls_label_y": 391,
    "tools_button_x": 34, "tools_button_y": 412, "tools_label_x": 68, "tools_label_y": 414,
    "recorded_header_x": 30, "recorded_header_y": 449,
    "recorded_divider_x": 32, "recorded_divider_y": 469, "recorded_divider_w": 236,
    "rares_button_x": 34, "rares_button_y": 490, "rares_label_x": 58, "rares_label_y": 486,
    "items_button_x": 34, "items_button_y": 519, "items_label_x": 58, "items_label_y": 515,
    "trap_header_x": 30, "trap_header_y": 556,
    "trap_divider_x": 32, "trap_divider_y": 576, "trap_divider_w": 236,
    "trap_info_x": 34, "trap_info_y": 595,
    "back_button_x": 34, "back_button_y": 650,
    "back_label_x": 68, "back_label_y": 652,

    # SHOP CATEGORY SELECTION GUMP
    "category_width": 300, "category_height": 483,
    "category_outer_x": 0, "category_outer_y": 0,
    "category_main_x": 16, "category_main_y": 16, "category_main_w": 268, "category_main_h": 398,
    "category_footer_x": 16, "category_footer_y": 422, "category_footer_w": 268, "category_footer_h": 45,
    "category_title_x": 21, "category_title_y": 27, "category_title_w": 258, "category_title_h": 22,
    "category_divider_x": 32, "category_divider_y": 51, "category_divider_w": 236,
    "category_equipment_button_x": 34, "category_equipment_button_y": 76,
    "category_equipment_label_x": 68, "category_equipment_label_y": 78,
    "category_food_button_x": 34, "category_food_button_y": 111,
    "category_food_label_x": 68, "category_food_label_y": 113,
    "category_gems_button_x": 34, "category_gems_button_y": 146,
    "category_gems_label_x": 68, "category_gems_label_y": 148,
    "category_potions_button_x": 34, "category_potions_button_y": 181,
    "category_potions_label_x": 68, "category_potions_label_y": 183,
    "category_reagents_button_x": 34, "category_reagents_button_y": 216,
    "category_reagents_label_x": 68, "category_reagents_label_y": 218,
    "category_refinements_button_x": 34, "category_refinements_button_y": 251,
    "category_refinements_label_x": 68, "category_refinements_label_y": 253,
    "category_resources_button_x": 34, "category_resources_button_y": 286,
    "category_resources_label_x": 68, "category_resources_label_y": 288,
    "category_scrolls_button_x": 34, "category_scrolls_button_y": 321,
    "category_scrolls_label_x": 68, "category_scrolls_label_y": 323,
    "category_tools_button_x": 34, "category_tools_button_y": 356,
    "category_tools_label_x": 68, "category_tools_label_y": 358,
    "category_back_button_x": 34, "category_back_button_y": 433,
    "category_back_label_x": 68, "category_back_label_y": 435,
}
...
BTN_SHOP_CATEGORY_EQUIPMENT = 401
BTN_SHOP_CATEGORY_FOOD = 402
BTN_SHOP_CATEGORY_GEMS = 403
BTN_SHOP_CATEGORY_POTIONS = 404
BTN_SHOP_CATEGORY_REAGENTS = 405
BTN_SHOP_CATEGORY_REFINEMENTS = 406
BTN_SHOP_CATEGORY_RESOURCES = 407
BTN_SHOP_CATEGORY_SPELL_SCROLLS = 408
BTN_SHOP_CATEGORY_TOOLS = 409
...
# Gump white (1152) renders dark blue in Misc.SendMessage. ClassicUO testing
# confirmed hue 1153 (0x0481) as the bright-white journal-message hue.
HUE_JOURNAL_NEUTRAL = 1153
HUE_INFO = HUE_JOURNAL_NEUTRAL
HUE_BLUE = 90
HUE_ORANGE = 44
...
# Keep the shared Dungeon default aligned even when Shop Mode is the first
# mode opened on a fresh installation.
...
def add_bag_row(gd, y, label, serial, button_id):
    add_art_button(gd, DL.get("bag_button_x", 34), y + 4, RUNEBOOK_BUTTON_NORMAL, RUNEBOOK_BUTTON_PRESSED, button_id)
...
def add_toggle_row(gd, y, label, enabled, button_id):
    art = CHECK_ON if enabled else CHECK_OFF
    Gumps.AddButton(gd, DL.get("toggle_button_x", 34), y - 2, art, art, button_id, 1, 0)
    Gumps.AddLabel(gd, DL.get("toggle_label_x", 68), y, HUE_ENABLED if enabled else HUE_DISABLED, label)


def add_cycle_row(gd, y, label, value, button_id, enabled=True):
    hue = HUE_TEXT if enabled else HUE_DISABLED
    add_art_button(gd, DL.get("tier_button_x", 34), DL.get("tier_button_y", y - 2), RUNEBOOK_BUTTON_NORMAL, RUNEBOOK_BUTTON_PRESSED, button_id)
    Gumps.AddLabel(gd, DL.get("tier_label_x", 58), y, hue, label + ":  " + value)


def add_value_button(gd, y, value, button_id, enabled=True):
    hue = HUE_TEXT if enabled else HUE_DISABLED
    add_art_button(gd, DL.get("trap_button_x", 34), DL.get("trap_button_y", y - 2), RUNEBOOK_BUTTON_NORMAL, RUNEBOOK_BUTTON_PRESSED, button_id)
...
def add_open_row(gd, y, label, button_id):
    if button_id == BTN_DUNGEON_OPEN_RARES:
        add_art_button(gd, DL["rares_button_x"], DL["rares_button_y"], RUNEBOOK_BUTTON_NORMAL, RUNEBOOK_BUTTON_PRESSED, button_id)
        Gumps.AddLabel(gd, DL["rares_label_x"], y, HUE_TEXT, label)
    else:
        add_art_button(gd, 34, y + 4, RUNEBOOK_BUTTON_NORMAL, RUNEBOOK_BUTTON_PRESSED, button_id)
        Gumps.AddLabel(gd, 58, y, HUE_TEXT, label)
...
def draw_main_gump():
    ...
    main_width = SL["main_width"]
    main_height = SL["main_height"]

    Gumps.AddBackground(gd, SL["main_outer_x"], SL["main_outer_y"], main_width, main_height, OUTER_ART)
    Gumps.AddBackground(gd, SL["main_upper_x"], SL["main_upper_y"], SL["main_upper_w"], SL["main_upper_h"], INNER_ART)
    Gumps.AddBackground(gd, SL["main_lower_x"], SL["main_lower_y"], SL["main_lower_w"], SL["main_lower_h"], INNER_ART)

    add_chestloot_title(gd, SL["main_title_x"], SL["main_title_y"], SL["main_title_w"], SL["main_title_h"])
    add_art_button(gd, SL["mode_button_x"], SL["mode_button_y"], MODE_BUTTON_NORMAL, MODE_BUTTON_PRESSED, BTN_PROFILE_SELECT)
    Gumps.AddLabel(gd, SL["mode_label_x"], SL["mode_label_y"], HUE_BLUE, "Shop Chest")
    add_art_button(gd, SL["options_button_x"], SL["options_button_y"], CONFIG_BUTTON_NORMAL, CONFIG_BUTTON_PRESSED, BTN_OPEN_OPTIONS)

    add_button(gd, SL["learn_rare_button_x"], SL["learn_rare_button_y"], BTN_LEARN_RARE)
    Gumps.AddLabel(gd, SL["learn_rare_label_x"], SL["learn_rare_label_y"], HUE_GOLD, "Learn Rare Item")
    add_button(gd, SL["learn_shop_button_x"], SL["learn_shop_button_y"], BTN_LEARN_SHOP_ITEM)
    Gumps.AddLabel(gd, SL["learn_shop_label_x"], SL["learn_shop_label_y"], HUE_GOLD, "Learn Shop Item")
    add_button(gd, SL["steal_button_x"], SL["steal_button_y"], BTN_STEAL_ITEM)
    Gumps.AddLabel(gd, SL["steal_label_x"], SL["steal_label_y"], HUE_DISABLED, "Steal Next Item")
    add_button(gd, SL["target_button_x"], SL["target_button_y"], BTN_TARGET)
    Gumps.AddLabel(gd, SL["target_label_x"], SL["target_label_y"], HUE_ENABLED, "Target Next Chest")
...
def draw_dungeon_options():
    ...
    gd = Gumps.CreateGump(True)
    Gumps.AddPage(gd, 0)
    Gumps.AddBackground(gd, DL["options_outer_x"], DL["options_outer_y"], DL["options_width"], DL["options_height"], OUTER_ART)
    Gumps.AddBackground(gd, DL["options_main_x"], DL["options_main_y"], DL["options_main_w"], DL["options_main_h"], INNER_ART)
    Gumps.AddBackground(gd, DL["options_footer_x"], DL["options_footer_y"], DL["options_footer_w"], DL["options_footer_h"], INNER_ART)
    Gumps.AddHtml(
        gd, DL["options_title_x"], DL["options_title_y"], DL["options_title_w"], DL["options_title_h"],
        "<center><basefont color=#FFFFFF>Dungeon Chest Options</basefont></center>", False, False
    )
    ...
    rows = [
        (DL["arrows_y"], "Arrows", "Arrows", BTN_DUNGEON_AMMO),
        (DL["blank_scrolls_y"], "Blank Scrolls", "Blank Scrolls", BTN_DUNGEON_BLANK_SCROLLS),
        (DL["bolts_y"], "Bolts", "Bolts", BTN_DUNGEON_BOLTS),
        (DL["gems_y"], "Gems", "Gems", BTN_DUNGEON_GEMS),
        (DL["gold_y"], "Gold", "Gold", BTN_DUNGEON_GOLD),
        (DL["magic_items_y"], "Magic Items", "Magic Items", BTN_DUNGEON_MAGIC),
        (DL["potions_y"], "Potions", "Potions", BTN_DUNGEON_POTIONS),
        (DL["reagents_y"], "Reagents", "Reagents", BTN_DUNGEON_REAGS),
        (DL["refinements_y"], "Refinements", "Refinements", BTN_DUNGEON_REFINEMENTS),
        (DL["spell_scrolls_y"], "Spell Scrolls", "Spell Scrolls", BTN_DUNGEON_SPELL_SCROLLS)
    ]
    for y, label, key, button_id in rows:
    ...
    add_open_row(gd, DL["rares_label_y"], "Rare Items", BTN_DUNGEON_OPEN_RARES)
...
def draw_shop_options():
    ...
    add_release_background(gd, SL["options_width"], SL["options_height"], [
        (SL["options_main_x"], SL["options_main_y"], SL["options_main_w"], SL["options_main_h"], INNER_ART),
        (SL["options_footer_x"], SL["options_footer_y"], SL["options_footer_w"], SL["options_footer_h"], INNER_ART)])
    add_chestloot_title(gd, 10, 10, SL["options_width"] - 20, 26)

    Gumps.AddHtml(gd, SL["bags_header_x"], SL["bags_header_y"], 220, 20, "<basefont color=#FFFF00>Loot Bags</basefont>", False, False)
    add_solid_divider(gd, SL["bags_divider_x"], SL["bags_divider_y"], SL["bags_divider_w"])
    shop_bags = [
        ("valuable", shop_valuables_bag, BTN_SHOP_VAL_BAG, "Valuables Bag"),
        ("shop_bag", shop_item_bag, BTN_SHOP_ITEM_BAG, "Shop Item Bag"),
        ("rare_bag", shared_rare_item_bag, BTN_SHOP_RARE_BAG, "Rare Item Bag")
    ]
    for key, serial, button_id, label in shop_bags:
        add_art_button(gd, SL[key + "_button_x"], SL[key + "_button_y"], ROW_ARROW_ART, ROW_ARROW_ART, button_id)
        Gumps.AddLabel(gd, SL[key + "_label_x"], SL[key + "_label_y"], HUE_TEXT, label + ":")
        Gumps.AddLabel(gd, SL[key + "_state_x"], SL[key + "_state_y"], bag_hue(serial), bag_state(serial))

    Gumps.AddHtml(gd, SL["types_header_x"], SL["types_header_y"], 220, 20, "<basefont color=#FFFF00>Loot Types</basefont>", False, False)
    add_solid_divider(gd, SL["types_divider_x"], SL["types_divider_y"], SL["types_divider_w"])
    shop_rows = [
        ("equipment", "Equipment", BTN_SHOP_EQUIPMENT),
        ("food", "Food", BTN_SHOP_FOOD),
        ("gems", "Gems", BTN_SHOP_GEMS),
        ("potions", "Potions", BTN_SHOP_POTIONS),
        ("reagents", "Reagents", BTN_SHOP_REAGENTS),
        ("refinements", "Refinements", BTN_SHOP_REFINEMENTS),
        ("resources", "Resources", BTN_SHOP_RESOURCES),
        ("scrolls", "Spell Scrolls", BTN_SHOP_SPELL_SCROLLS),
        ("tools", "Tools", BTN_SHOP_TOOLS)
    ]
    for key, label, button_id in shop_rows:
        Gumps.AddButton(gd, SL[key + "_button_x"], SL[key + "_button_y"], CHECK_ON if shop_options[label] else CHECK_OFF, CHECK_ON if shop_options[label] else CHECK_OFF, button_id, 1, 0)
        Gumps.AddLabel(gd, SL[key + "_label_x"], SL[key + "_label_y"], HUE_ENABLED if shop_options[label] else HUE_DISABLED, label)

    Gumps.AddHtml(gd, SL["recorded_header_x"], SL["recorded_header_y"], 220, 20, "<basefont color=#FFFF00>Recorded Items</basefont>", False, False)
    add_solid_divider(gd, SL["recorded_divider_x"], SL["recorded_divider_y"], SL["recorded_divider_w"])
    add_art_button(gd, SL["rares_button_x"], SL["rares_button_y"], ROW_ARROW_ART, ROW_ARROW_ART, BTN_SHOP_OPEN_RARES)
    Gumps.AddLabel(gd, SL["rares_label_x"], SL["rares_label_y"], HUE_TEXT, "Rare Items")
    add_art_button(gd, SL["items_button_x"], SL["items_button_y"], RUNEBOOK_BUTTON_NORMAL, RUNEBOOK_BUTTON_PRESSED, BTN_SHOP_OPEN_ITEMS)
    Gumps.AddLabel(gd, SL["items_label_x"], SL["items_label_y"], HUE_TEXT, "Shop Items")

    Gumps.AddHtml(gd, SL["trap_header_x"], SL["trap_header_y"], 220, 20, "<basefont color=#FFFF00>Trap Removal Method</basefont>", False, False)
    add_solid_divider(gd, SL["trap_divider_x"], SL["trap_divider_y"], SL["trap_divider_w"])
    Gumps.AddLabel(gd, SL["trap_info_x"], SL["trap_info_y"], HUE_TEXT, "Remove Trap Required")

    add_art_button(gd, SL["back_button_x"], SL["back_button_y"], LEFT_ARROW_NORMAL, LEFT_ARROW_PRESSED, BTN_OPTIONS_BACK)
    Gumps.AddLabel(gd, SL["back_label_x"], SL["back_label_y"], HUE_GOLD, "Back")
    Gumps.SendGump(
        OPTIONS_GUMP_ID,
        Player.Serial,
        GUMP_X,
...
def _legacy_handle_dungeon_option(button_id):
    ...
    if button_id in toggle_map:
        ...
        cm_msg("{} looting is now {}.".format(key, state_text), HUE_GOLD)
        ...
        if dungeon_options["Magic Items"]:
            ...
            cm_msg("Minimum Magic Tier is now {}.".format(MAGIC_TIERS[dungeon_magic_tier_index]), HUE_GOLD)
    elif button_id == BTN_DUNGEON_TRAP_CYCLE:
        dungeon_trap_method = TRAP_SKILL if dungeon_trap_method == TRAP_MAGIC else TRAP_MAGIC
        cm_msg("{} has been selected.".format(TRAP_NAMES[dungeon_trap_method]), HUE_GOLD)
...
def _legacy_handle_shop_option(button_id):
    ...
    toggle_map = {
        BTN_SHOP_EQUIPMENT: "Equipment",
        BTN_SHOP_FOOD: "Food",
        BTN_SHOP_GEMS: "Gems",
        BTN_SHOP_POTIONS: "Potions",
        BTN_SHOP_REAGENTS: "Reagents",
        BTN_SHOP_REFINEMENTS: "Refinements",
        BTN_SHOP_RESOURCES: "Resources",
        BTN_SHOP_SPELL_SCROLLS: "Spell Scrolls",
    ...
    if button_id in toggle_map:
        ...
        cm_msg("{} looting is now {}.".format(key, "enabled" if shop_options[key] else "disabled"), HUE_GOLD)
...
def handle_options_screen():
    ...
    if button_id == BTN_OPTIONS_BACK:
        ...
        draw_main_gump()
        return
    if button_id == BTN_TRANSPARENT_GUMPS and active_profile == PROFILE_SHOP:
        try:
...
SPELL_FAIL = ["The spell fizzles","You have not yet recovered from casting a spell","You must wait to perform another action","You lack the mana","Insufficient mana","Your concentration is disturbed"] + SPELL_CAST_CONFLICT_MESSAGES + HARD_STOP
...
shop_stole_from_current_chest = False
...
def save_all():
    ...
    knowledge={"rare_items":rare_items,"ignored_items":ignored_items,"shop_items":shop_items}
    try:
...
def load_all():
    ...
    try:
        ...
        kotl_options.update(data.get("kotl_options",{}))
        saved_shop_options = data.get("shop_options", {}) or {}
        for key in shop_options:
            if key in saved_shop_options:
                shop_options[key] = bool(saved_shop_options[key])
        # Migrate the obsolete six-category Shop test without discarding the
        # player's prior enable/disable choices.
        if "Consumables" in saved_shop_options:
            for key in ("Food", "Potions", "Spell Scrolls"):
                if key not in saved_shop_options:
                    shop_options[key] = bool(saved_shop_options["Consumables"])
        if "Decorations" in saved_shop_options and "Resources" not in saved_shop_options:
            shop_options["Resources"] = bool(saved_shop_options["Decorations"])
    ...
    try:
        ...
        for entry in shop_items:
            ...
            iid = int(entry.get("id", -1))
            if old_category == "Consumables":
                if iid in POTION_IDS:
                    entry["category"] = "Potions"
                elif SPELL_SCROLL_MIN <= iid <= SPELL_SCROLL_MAX:
                    entry["category"] = "Spell Scrolls"
                else:
                    entry["category"] = "Food"
            else:
                entry["category"] = normalize_shop_category(old_category)
    except: pass
...
def set_bag(button_id):
    ...
    serial=request_container("Choose the container that will receive these treasures.")
    ...
    save_all(); cm_msg("Your {} has been recorded.".format(bag_name), HUE_GOLD)


def learn_rare():
    item=request_item("Target the rare item to record.")
    if not item: cm_msg("No treasure was recorded.",HUE_DISABLED); return
    if add_entry(rare_items,item): cm_msg("This treasure has been added to your journal.",HUE_ENABLED)
    else: cm_msg("This treasure is already recorded.",HUE_INFO)
    save_all()
...
def infer_shop_category(item):
    ...
    if iid in POTION_IDS or "potion" in text_value:
        return "Potions"
    if SPELL_SCROLL_MIN <= iid <= SPELL_SCROLL_MAX or "scroll" in text_value:
        return "Spell Scrolls"
    if iid in FOOD_IDS or any(word in text_value for word in ["food", "bread", "fish", "meat", "fruit", "vegetable", "apple", "pear", "grape", "wine", "liquor", "ale"]):
        return "Food"
    if iid in GEM_IDS:
        return "Gems"
    if iid in REAGENT_IDS:
        return "Reagents"
...
SHOP_CATEGORY_BUTTONS = [
    ...
    (BTN_SHOP_CATEGORY_FOOD, "Food"),
    (BTN_SHOP_CATEGORY_GEMS, "Gems"),
    (BTN_SHOP_CATEGORY_POTIONS, "Potions"),
    (BTN_SHOP_CATEGORY_REAGENTS, "Reagents"),
    (BTN_SHOP_CATEGORY_REFINEMENTS, "Refinements"),
    (BTN_SHOP_CATEGORY_RESOURCES, "Resources"),
    (BTN_SHOP_CATEGORY_SPELL_SCROLLS, "Spell Scrolls"),
...
def choose_shop_category():
    ...
    gd = Gumps.CreateGump(True)
    Gumps.AddPage(gd, 0)
    add_release_background(gd, SL["category_width"], SL["category_height"], [
        (SL["category_main_x"], SL["category_main_y"], SL["category_main_w"], SL["category_main_h"], INNER_ART),
        (SL["category_footer_x"], SL["category_footer_y"], SL["category_footer_w"], SL["category_footer_h"], INNER_ART)])
    Gumps.AddHtml(gd, SL["category_title_x"], SL["category_title_y"], SL["category_title_w"], SL["category_title_h"], "<center><basefont color=#FFFFFF>Choose Shop Item Category</basefont></center>", False, False)
    add_solid_divider(gd, SL["category_divider_x"], SL["category_divider_y"], SL["category_divider_w"])

    category_keys = ["equipment", "food", "gems", "potions", "reagents", "refinements", "resources", "scrolls", "tools"]
    for (button_id, category), key in zip(SHOP_CATEGORY_BUTTONS, category_keys):
        add_button(gd, SL["category_" + key + "_button_x"], SL["category_" + key + "_button_y"], button_id)
        Gumps.AddLabel(gd, SL["category_" + key + "_label_x"], SL["category_" + key + "_label_y"], HUE_TEXT, category)

    add_art_button(gd, SL["category_back_button_x"], SL["category_back_button_y"], LEFT_ARROW_NORMAL, LEFT_ARROW_PRESSED, BTN_SHOP_CATEGORY_CANCEL)
    Gumps.AddLabel(gd, SL["category_back_label_x"], SL["category_back_label_y"], HUE_GOLD, "Back")
...
def remove_trap(chest,method):
    for _ in range(MAX_TRAP_ATTEMPTS):
        ...
        if method==TRAP_MAGIC:
            ok=use_targeted(lambda:Spells.CastMagery(MAGIC_UNTRAP_SPELL),chest)
            fail=SPELL_FAIL
        else:
            ok=use_targeted(lambda:Player.UseSkill(REMOVE_TRAP_SKILL),chest)
            fail=TRAP_FAIL
        if not ok: return False
        success_messages = TRAP_SUCCESS if method == TRAP_MAGIC else (TRAP_SUCCESS + TRAP_NOT_PRESENT)
        result=wait_journal(success_messages,fail,MAGIC_UNTRAP_CONFIRM_TIMEOUT if method==TRAP_MAGIC else 3500)
        if result=="success": return True
        if result=="hard": return False
        if method==TRAP_MAGIC and journal_has(SPELL_CAST_CONFLICT_MESSAGES):
            cm_msg("You are already casting a spell. Magic Untrap will try again.", HUE_DISABLED)
            Misc.Pause(MAGIC_UNTRAP_CAST_CONFLICT_DELAY)
            continue
        ...
        if method==TRAP_MAGIC and result=="timeout":
            return True
        Misc.Pause(1000)
...
def open_with_repick(chest, description, trap_method=None):
    ...
    for _ in range(3):
        ...
        if state=="hard": return None
        if state=="locked":
            if not pick_lock(chest): return None
            retry_method = dungeon_trap_method if trap_method is None else trap_method
            if not remove_trap(chest,retry_method): return None
            continue
        break
...
def move_stolen_item_confirmed(item, destination):
    """Sort one stolen item and verify its exact destination container."""
    for _ in range(MAX_MOVE_ATTEMPTS):
        current = Items.FindBySerial(item.Serial)
        if current is None:
            return False
        if _item_container_serial(current) == int(destination):
            return True
        try:
            Items.Move(current.Serial, int(destination), 0)
        except:
            pass
        Misc.Pause(MOVE_INTERVAL)
        current = Items.FindBySerial(item.Serial)
        if current is not None and _item_container_serial(current) == int(destination):
            return True
    cm_msg("You cannot secure the stolen item in its chosen bag.", HUE_DISABLED)
    return False


def play_rare_found():
    """Play the established Rare alert and use the approved orange hue."""
    try:
    ...
    for item in contents:
        ...
        if is_recognized_equipment(item):
            ...
            if dungeon_options["Magic Items"] and tier is not None and tier >= dungeon_magic_tier_index:
                magic.append(item)
            elif dungeon_options["Magic Items"] and item_name(item).lower() == "wand" and dungeon_magic_tier_index == 0:
                magic.append(item)
            continue
...
def loot_dungeon_snapshot(chest, contents):
    ...
    if has_daily_rare(chest, remaining, prop_cache):
        ...
        cm_msg("You finish collecting the treasure you recognize.", HUE_ENABLED)
    return True
...
def dungeon_destination(item):
    ...
    if dungeon_options["Magic Items"]:
        ...
        if item_name(item).lower()=="wand" and dungeon_magic_tier_index==0: return dungeon_magic_bag or Player.Backpack.Serial
    return None
...
def loot_container(chest,destination_fn,unknown_warning=False):
    ...
    cm_msg("You begin searching the chest for valuable treasures.")
    ...
    while moved_any:
        ...
        try:
            if chest is None or chest.Contains is None:
                cm_msg("You find nothing else of value.")
                return
    ...
    if unknown_warning:
        try:
            ...
            if any(not dungeon_item_is_known(item) for item in remaining):
                cm_msg("Something unfamiliar catches your eye.", HUE_GOLD)
        except:
            pass
...
def _shop_candidates(chest):
    """Return eligible Shop items in the approved stealing priority."""
    try:
        refreshed = Items.FindBySerial(chest.Serial)
        ...
        contents = []
    priority = {
        "Rare Items": 0, "Tools": 1, "Refinements": 2, "Resources": 3,
        "Gems": 4, "Reagents": 5, "Equipment": 6, "Food": 7,
        "Potions": 8, "Spell Scrolls": 9
    }
    eligible = [item for item in contents if shop_is_eligible(item)]
    return sorted(eligible, key=lambda item: (priority.get(shop_category(item), 99), int(item.Serial)))


def _shop_destination(item):
    if has_entry(rare_items, item):
        return shared_rare_item_bag or Player.Backpack.Serial
    if shop_category(item) == "Gems" or int(item.ItemID) in GOLD_IDS:
        return shop_valuables_bag or Player.Backpack.Serial
    return shop_item_bag or Player.Backpack.Serial


def shop_no_candidate_message():
    """Describe why Shop has no eligible item without implying a theft occurred."""
    if shop_stole_from_current_chest:
        cm_msg("You finish collecting the treasure you recognize.", HUE_ENABLED)
    elif not any(bool(shop_options.get(category, False)) for category in shop_options):
        cm_msg("You have selected no shop treasures to collect.", HUE_INFO)
    else:
        cm_msg("You find nothing here recorded in your journal.", HUE_INFO)


def run_shop_target():
    global current_shop_chest, shop_steal_ready_at, shop_stole_from_current_chest
    required_bags = [
        (shop_valuables_bag, "Valuables Bag"),
        (shop_item_bag, "Shop Item Bag"),
        (shared_rare_item_bag, "Rare Item Bag")
    ]
    for serial, label in required_bags:
        if not validate_loot_bag(serial, label):
            return
    chest = target_container("")
    if not chest:
        return
    ...
    if not remove_trap(chest, TRAP_SKILL):
        return
    contents = open_with_repick(chest, "shop chest", TRAP_SKILL)
    if contents is None:
        return
    ...
    if candidates:
        ...
        cm_msg(
            "The shop owner remains watchful. You may attempt a theft in {:.1f} seconds.".format(SHOP_STEAL_COOLDOWN_SECONDS),
            HUE_INFO
        )
    else:
        shop_steal_ready_at = 0.0
        shop_no_candidate_message()
...
def steal_next():
    ...
    if time.time() < shop_steal_ready_at:
        remaining_seconds = max(0.1, shop_steal_ready_at - time.time())
        cm_msg("The chest gives a faint creak, drawing the shop owner\'s attention. You decide to wait {:.1f} seconds.".format(remaining_seconds), HUE_BLUE)
        return
    ...
    if is_recorded_rare:
        destination_serial, destination_label = shared_rare_item_bag, "Rare Item Bag"
    elif shop_category(item) == "Gems" or int(item.ItemID) in GOLD_IDS:
        destination_serial, destination_label = shop_valuables_bag, "Valuables Bag"
    else:
        destination_serial, destination_label = shop_item_bag, "Shop Item Bag"
    if not validate_loot_bag(destination_serial, destination_label):
        return
    ...
    if result == "success":
        shop_stole_from_current_chest = True
        ...
        if stolen:
            ...
            if destination != Player.Backpack.Serial:
                if not move_stolen_item_confirmed(stolen, destination):
                    return
            if is_recorded_rare:
                play_rare_found()
        ...
        if remaining:
            shop_steal_ready_at = time.time() + SHOP_STEAL_COOLDOWN_SECONDS
            cm_msg(
                "The shop owner turns their attention back to the chest. You may try again in {:.1f} seconds.".format(SHOP_STEAL_COOLDOWN_SECONDS),
                HUE_INFO
            )
        else:
            shop_steal_ready_at = 0.0
        ...
        cm_msg("You are not yet ready. Try again shortly.", HUE_DISABLED)
    else:
        cm_msg(
...
def draw_list_gump():
    ...
    Gumps.AddBackground(gd, DL["list_main_x"], DL["list_main_y"], DL["list_main_w"], DL["list_main_h"], INNER_ART)
    Gumps.AddBackground(gd, DL["list_footer_x"], footer_y, DL["list_footer_w"], DL["list_footer_h"], INNER_ART)

    add_centered_title(gd, width, DL["list_title_y"], title)
    add_solid_divider(gd, DL["list_divider_x"], DL["list_divider_y"], DL["list_divider_w"])
    ...
    if not visible_entries:
        ...
        for page_index, entry in enumerate(visible_entries):
            ...
            if active_list_name == "rare":
                category_text = "Rare"
                category_hue = HUE_ORANGE
            else:
                category_text = normalize_shop_category(entry.get("category"))
                category_hue = HUE_BLUE
            Gumps.AddLabel(gd, DL["list_category_label_x"], DL["list_category_label_y"] + offset, category_hue, category_text)
            add_art_button(
                gd,
...
def handle_list_screen():
    ...
    if button_id>=BTN_LIST_REMOVE_BASE:
        ...
        if 0<=index<len(entries):
            removed=entries.pop(index);cm_msg("Removed from {}: {}".format(title,removed.get("name","Unknown Item")),HUE_DISABLED);save_all()
        draw_list_gump()


# ============================================================
# SHOP v0.2.0 MANUAL WORKFLOW OVERRIDES
# These final definitions replace the earlier shared-engine Shop prototype.
# ============================================================

VERSION = "1.0"

# Shop-specific records and destination. These do not share Dungeon Rare data.
shop_rare_items = []
shop_rare_item_bag = None

# Compact layouts. Every visible control retains an independent coordinate.
SL.update({
    # Main gump
    "main_width": 212, "main_height": 262,
    "main_outer_x": 0, "main_outer_y": 0,
    "main_title_x": 10, "main_title_y": 10, "main_title_w": 192, "main_title_h": 26,
    "main_upper_x": 16, "main_upper_y": 32, "main_upper_w": 180, "main_upper_h": 85,
    "main_lower_x": 16, "main_lower_y": 125, "main_lower_w": 180, "main_lower_h": 121,
    "mode_button_x": 26, "mode_button_y": 45,
    "mode_label_x": 60, "mode_label_y": 49,
    "options_button_x": 76, "options_button_y": 81,
    "record_rare_button_x": 26, "record_rare_button_y": 138,
    "record_rare_label_x": 60, "record_rare_label_y": 140,
    "steal_button_x": 26, "steal_button_y": 174,
    "steal_label_x": 60, "steal_label_y": 176,
    "target_button_x": 26, "target_button_y": 210,
    "target_label_x": 60, "target_label_y": 212,

    # Options gump
    # Width fits the action + longest bag label + state, with frame clearance.
    "options_width": 288, "options_height": 451,
    "options_outer_x": 0, "options_outer_y": 0,
    "options_main_x": 16, "options_main_y": 32, "options_main_w": 256, "options_main_h": 350,
    "options_footer_x": 16, "options_footer_y": 390, "options_footer_w": 256, "options_footer_h": 45,
    "options_title_x": 21, "options_title_y": 27, "options_title_w": 258, "options_title_h": 22,
    "bags_header_x": 30, "bags_header_y": 62,
    "bags_divider_x": 32, "bags_divider_y": 82, "bags_divider_w": 224,
    "shop_bag_button_x": 34, "shop_bag_button_y": 100,
    "shop_bag_label_x": 68, "shop_bag_label_y": 99,
    "shop_bag_state_x": 208, "shop_bag_state_y": 99,
    "rare_bag_button_x": 34, "rare_bag_button_y": 129,
    "rare_bag_label_x": 68, "rare_bag_label_y": 128,
    "rare_bag_state_x": 208, "rare_bag_state_y": 128,
    "trap_header_x": 30, "trap_header_y": 163,
    "trap_divider_x": 32, "trap_divider_y": 183, "trap_divider_w": 224,
    "trap_info_x": 34, "trap_info_y": 200,
    "recorded_header_x": 30, "recorded_header_y": 235,
    "recorded_divider_x": 32, "recorded_divider_y": 255, "recorded_divider_w": 224,
    "rares_button_x": 34, "rares_button_y": 273,
    "rares_label_x": 68, "rares_label_y": 272,
    "back_button_x": 34, "back_button_y": 401,
    "back_label_x": 68, "back_label_y": 403,

    # Category-free Shop Rare list
    ...
    "list_remove_label_x": 304, "list_remove_label_y": 78,
    "list_row_spacing": 35,
    "list_page_x": 150, "list_page_y": 374,
    "list_back_button_x": 28, "list_back_button_y": 397,
    "list_back_label_x": 62, "list_back_label_y": 399,
    "list_prev_button_x": 160, "list_prev_button_y": 397,
    "list_prev_label_x": 194, "list_prev_label_y": 399,
    "list_next_button_x": 292, "list_next_button_y": 397,
    "list_next_label_x": 326, "list_next_label_y": 399
})


def save_all():
    # Preserve settings owned by the other modes. All four modes share these
    # JSON files, so replacing the whole document here would erase fields that
    # Shop Chest Mode does not own.
    try:
    ...
    settings.update({
        ...
        "dungeon_valuables_bag": dungeon_valuables_bag,
        "dungeon_magic_bag": dungeon_magic_bag,
        "shared_rare_item_bag": shared_rare_item_bag,
        "kotl_valuables_bag": kotl_valuables_bag,
        "kotl_item_bag": kotl_item_bag,
        "shop_item_bag": shop_item_bag,
        "shop_rare_item_bag": shop_rare_item_bag,
        "dungeon_options": dungeon_options,
        "dungeon_magic_tier_index": dungeon_magic_tier_index,
        "dungeon_trap_method": dungeon_trap_method,
        "kotl_options": kotl_options,
        "kotl_trap_method": kotl_trap_method
    })
    try:
        with open(knowledge_path(), "r") as handle:
    ...
    knowledge.update({
        ...
        "shop_rare_items": shop_rare_items
    })
    try:
        with open(settings_path(), "w") as handle:
            json.dump(settings, handle, indent=2)
        with open(knowledge_path(), "w") as handle:
...
def load_all():
    global active_profile, loot_enabled, dungeon_valuables_bag, dungeon_magic_bag
    global shared_rare_item_bag, kotl_valuables_bag, kotl_item_bag, shop_item_bag
    global shop_rare_item_bag, dungeon_magic_tier_index, dungeon_trap_method
    global kotl_trap_method, rare_items, ignored_items, shop_rare_items
    try:
        with open(settings_path(), "r") as handle:
            data = json.load(handle)
        active_profile = int(data.get("active_profile", active_profile))
        loot_enabled = bool(data.get("loot_enabled", loot_enabled))
        dungeon_valuables_bag = data.get("dungeon_valuables_bag")
        dungeon_magic_bag = data.get("dungeon_magic_bag")
        shared_rare_item_bag = data.get("shared_rare_item_bag")
        kotl_valuables_bag = data.get("kotl_valuables_bag")
        kotl_item_bag = data.get("kotl_item_bag")
        shop_item_bag = data.get("shop_item_bag")
        shop_rare_item_bag = data.get("shop_rare_item_bag")
        dungeon_options.update(data.get("dungeon_options", {}) or {})
        kotl_options.update(data.get("kotl_options", {}) or {})
        dungeon_magic_tier_index = int(data.get("dungeon_magic_tier_index", dungeon_magic_tier_index))
        dungeon_trap_method = int(data.get("dungeon_trap_method", dungeon_trap_method))
        kotl_trap_method = int(data.get("kotl_trap_method", kotl_trap_method))
    except:
        pass
    try:
        with open(knowledge_path(), "r") as handle:
            data = json.load(handle)
        rare_items = data.get("rare_items", []) or []
        ignored_items = data.get("ignored_items", []) or []
        shop_rare_items = data.get("shop_rare_items", []) or []
    except:
        pass


def set_bag(button_id):
    global shop_item_bag, shop_rare_item_bag
    serial = request_container("")
    if not serial:
        return
    if button_id == BTN_SHOP_ITEM_BAG:
        shop_item_bag = serial
        label = "Shop Item Bag"
    elif button_id == BTN_SHOP_RARE_BAG:
        shop_rare_item_bag = serial
        label = "Rare Shop Item Bag"
    else:
        return
    save_all()
    cm_msg("Your {} has been recorded.".format(label), HUE_JOURNAL_OPTION)


def record_shop_rare():
    item = request_item("Target the rare shop item to record.")
    if not item:
        cm_msg("No shop treasure was recorded.", HUE_DISABLED)
        return
    if add_entry(shop_rare_items, item):
        cm_msg("This treasure has been added to your journal.", HUE_JOURNAL_OPTION)
    else:
        cm_msg("This treasure is already recorded.", HUE_JOURNAL_OPTION)
    save_all()
...
def draw_main_gump():
    ...
    gd = Gumps.CreateGump(True)
    Gumps.AddPage(gd, 0)
    add_release_background(gd, SL["main_width"], SL["main_height"], [
        (SL["main_upper_x"], SL["main_upper_y"], SL["main_upper_w"], SL["main_upper_h"], INNER_ART),
        (SL["main_lower_x"], SL["main_lower_y"], SL["main_lower_w"], SL["main_lower_h"], INNER_ART)])
    add_chestloot_title(gd, SL["main_title_x"], SL["main_title_y"], SL["main_title_w"], SL["main_title_h"])
    add_art_button(gd, SL["mode_button_x"], SL["mode_button_y"], MODE_BUTTON_NORMAL, MODE_BUTTON_PRESSED, BTN_PROFILE_SELECT)
    Gumps.AddLabel(gd, SL["mode_label_x"], SL["mode_label_y"], HUE_BLUE, "Shop Chest")
    add_art_button(gd, SL["options_button_x"], SL["options_button_y"], CONFIG_BUTTON_NORMAL, CONFIG_BUTTON_PRESSED, BTN_OPEN_OPTIONS)
    add_button(gd, SL["record_rare_button_x"], SL["record_rare_button_y"], BTN_LEARN_RARE)
    Gumps.AddLabel(gd, SL["record_rare_label_x"], SL["record_rare_label_y"], HUE_GOLD, "Record Shop Rare")
    add_button(gd, SL["steal_button_x"], SL["steal_button_y"], BTN_STEAL_ITEM)
    Gumps.AddLabel(gd, SL["steal_label_x"], SL["steal_label_y"], HUE_DISABLED, "Steal Item")
    add_button(gd, SL["target_button_x"], SL["target_button_y"], BTN_TARGET)
    Gumps.AddLabel(gd, SL["target_label_x"], SL["target_label_y"], HUE_ENABLED, "Target Chest")
    Gumps.SendGump(MAIN_GUMP_ID, Player.Serial, GUMP_X, GUMP_Y, gd.gumpDefinition, gd.gumpStrings)
...
def draw_shop_options():
    ...
    Gumps.AddHtml(gd, SL["bags_header_x"], SL["bags_header_y"], 220, 20, "<basefont color=#FFFF00>Loot Bags</basefont>", False, False)
    add_solid_divider(gd, SL["bags_divider_x"], SL["bags_divider_y"], SL["bags_divider_w"])
    for key, serial, button_id, label in [
        ("shop_bag", shop_item_bag, BTN_SHOP_ITEM_BAG, "Shop Item Bag"),
        ("rare_bag", shop_rare_item_bag, BTN_SHOP_RARE_BAG, "Rare Shop Item Bag")
    ]:
        add_art_button(gd, SL[key + "_button_x"], SL[key + "_button_y"], ROW_ARROW_ART, ROW_ARROW_ART, button_id)
        Gumps.AddLabel(gd, SL[key + "_label_x"], SL[key + "_label_y"], HUE_TEXT, label + ":")
        Gumps.AddLabel(gd, SL[key + "_state_x"], SL[key + "_state_y"], bag_hue(serial), bag_state(serial))
    ...
    add_solid_divider(gd, SL["recorded_divider_x"], SL["recorded_divider_y"], SL["recorded_divider_w"])
    add_art_button(gd, SL["rares_button_x"], SL["rares_button_y"], ROW_ARROW_ART, ROW_ARROW_ART, BTN_SHOP_OPEN_RARES)
    Gumps.AddLabel(gd, SL["rares_label_x"], SL["rares_label_y"], HUE_TEXT, "Rare Shop Items")

    Gumps.AddHtml(gd, 30, 307, 220, 20, "<basefont color=#FFFF00>Transparency</basefont>", False, False)
    add_solid_divider(gd, 32, 327, 224)
    on = transparent_ui.enabled(settings_path(), Player.Serial)
    art = CHECK_ON if on else CHECK_OFF
    Gumps.AddButton(gd, 34, 345, art, art, BTN_TRANSPARENT_GUMPS, 1, 0)
    Gumps.AddLabel(gd, 68, 347, HUE_ENABLED if on else HUE_TEXT, "Transparent Gumps")
    add_art_button(gd, SL["back_button_x"], SL["back_button_y"], LEFT_ARROW_NORMAL, LEFT_ARROW_PRESSED, BTN_OPTIONS_BACK)
    Gumps.AddLabel(gd, SL["back_label_x"], SL["back_label_y"], HUE_GOLD, "Back")
    Gumps.SendGump(OPTIONS_GUMP_ID, Player.Serial, GUMP_X, GUMP_Y, gd.gumpDefinition, gd.gumpStrings)
...
def get_active_list():
    return shop_rare_items, "Rare Shop Items"
...
def draw_list_gump():
    ...
    gd = Gumps.CreateGump(True)
    Gumps.AddPage(gd, 0)
    add_release_background(gd, SL["list_width"], SL["list_height"], [
        (SL["list_main_x"], SL["list_main_y"], SL["list_main_w"], SL["list_main_h"], INNER_ART),
        (SL["list_footer_x"], SL["list_footer_y"], SL["list_footer_w"], SL["list_footer_h"], INNER_ART)])
    add_chestloot_title(gd, 10, 10, SL["list_width"] - 20, 26)
    add_centered_title(gd, SL["list_width"], SL["list_title_y"], title)
    if not visible_entries:
        Gumps.AddLabel(gd, SL["list_empty_x"], SL["list_empty_y"], HUE_DISABLED, "No entries recorded.")
    else:
        for page_index, entry in enumerate(visible_entries):
            absolute_index = start_index + page_index
            offset = page_index * SL["list_row_spacing"]
            Gumps.AddLabel(gd, SL["list_row_label_x"], SL["list_row_label_y"] + offset, HUE_TEXT, entry.get("name", "Unknown Item"))
            add_art_button(gd, SL["list_row_button_x"], SL["list_row_button_y"] + offset, CLOSE_BUTTON_NORMAL, CLOSE_BUTTON_PRESSED, BTN_LIST_REMOVE_BASE + absolute_index)
            Gumps.AddLabel(gd, SL["list_remove_label_x"], SL["list_remove_label_y"] + offset, HUE_DISABLED, "Remove")
    Gumps.AddLabel(gd, SL["list_page_x"], SL["list_page_y"], HUE_TEXT, "Page {} of {}".format(active_list_page + 1, page_count))
    if active_list_page > 0:
        add_art_button(gd, SL["list_prev_button_x"], SL["list_prev_button_y"], LEFT_ARROW_NORMAL, LEFT_ARROW_PRESSED, BTN_LIST_PREV)
        Gumps.AddLabel(gd, SL["list_prev_label_x"], SL["list_prev_label_y"], HUE_GOLD, "Prev")
    add_art_button(gd, SL["list_back_button_x"], SL["list_back_button_y"], LEFT_ARROW_NORMAL, LEFT_ARROW_PRESSED, BTN_LIST_BACK)
    Gumps.AddLabel(gd, SL["list_back_label_x"], SL["list_back_label_y"], HUE_GOLD, "Back")
    if active_list_page < page_count - 1:
        add_art_button(gd, SL["list_next_button_x"], SL["list_next_button_y"], ACTION_BUTTON_NORMAL, ACTION_BUTTON_PRESSED, BTN_LIST_NEXT)
        Gumps.AddLabel(gd, SL["list_next_label_x"], SL["list_next_label_y"], HUE_GOLD, "Next")
    Gumps.SendGump(LIST_GUMP_ID, Player.Serial, GUMP_X, GUMP_Y, gd.gumpDefinition, gd.gumpStrings)


def shop_rare_count_message():
    count = len(shop_rare_items)
    if count == 0:
        text = "Your Rare Shop Items list contains no recorded treasures."
    elif count == 1:
        text = "Your Rare Shop Items list contains 1 recorded treasure."
    else:
        text = "Your Rare Shop Items list contains {} recorded treasures.".format(count)
    # Match the approved Dungeon Chest Mode rare-count message exactly.
    cm_msg(text, HUE_JOURNAL_OPTION)


def handle_shop_option(button_id):
    if button_id in (BTN_SHOP_ITEM_BAG, BTN_SHOP_RARE_BAG):
        set_bag(button_id)
    elif button_id == BTN_SHOP_OPEN_RARES:
        shop_rare_count_message()
        open_list("shop_rare")
    save_all()
...
def run_shop_target():
    ...
    shop_stole_from_current_chest = False
    shop_steal_ready_at = time.time() + SHOP_STEAL_COOLDOWN_SECONDS
    cm_msg("The shop owner remains watchful. Choose your moment carefully.", HUE_BLUE)


def item_belongs_to_current_chest(item, chest):
    if item is None or chest is None:
        return False
    return _item_container_serial(item) == int(chest.Serial)


def wait_for_consequence_gump(previous_gump):
    """Yield completely to the shard's Escape/Fight decision gump."""
    consequence_id = 0
    started = time.time()
    while time.time() - started < 2.5:
        try:
            current = int(Gumps.CurrentGump()) if Gumps.HasGump() else 0
        except:
            current = 0
        if current and current != previous_gump and current not in (MAIN_GUMP_ID, OPTIONS_GUMP_ID, LIST_GUMP_ID):
            consequence_id = current
            break
        Misc.Pause(100)
    ...
    while True:
        try:
            if not Gumps.HasGump() or int(Gumps.CurrentGump()) != consequence_id:
                break
        except:
            break
        Misc.Pause(100)
...
def steal_item():
    ...
    if not current_shop_chest:
        ...
        return
    if time.time() < shop_steal_ready_at:
        remaining = max(0.1, shop_steal_ready_at - time.time())
        cm_msg("The chest gives a faint creak, drawing the shop owner\'s attention. You decide to wait {:.1f} seconds.".format(remaining), HUE_BLUE)
        return
    try:
        chest = Items.FindBySerial(current_shop_chest)
    except:
        chest = None
    if not chest:
        cm_msg("The shop chest is beyond your reach. Move closer and try again.", HUE_DISABLED)
        return
    if not chest_is_reachable(chest):
        cm_msg("The shop chest is beyond your reach. Move closer and try again.", HUE_DISABLED)
        return
    if over_weight():
        cm_msg("Your pack is nearly full.", HUE_DISABLED)
    ...
    item = request_item("")
    if not item:
        cm_msg("No shop item was selected.", HUE_DISABLED)
        return
    if not item_belongs_to_current_chest(item, chest):
        cm_msg("Choose an item from the current shop chest.", HUE_DISABLED)
        return

    is_shop_rare = has_entry(shop_rare_items, item)
    destination = shop_rare_item_bag if is_shop_rare else shop_item_bag
    destination_label = "Rare Shop Item Bag" if is_shop_rare else "Shop Item Bag"
    if not validate_loot_bag(destination, destination_label):
        return

    try:
        previous_gump = int(Gumps.CurrentGump()) if Gumps.HasGump() else 0
    except:
        previous_gump = 0
    try:
        Journal.Clear()
    ...
    try:
        ...
        stolen = None
    if result != "success" and stolen is not None and _item_container_serial(stolen) == int(Player.Backpack.Serial):
        result = "success"

    if result == "success":
        shop_stole_from_current_chest = True
        if stolen is not None and int(destination) != int(Player.Backpack.Serial):
            if not move_stolen_item_confirmed(stolen, destination):
                return
        if is_shop_rare:
            play_rare_found()
        shop_steal_ready_at = time.time() + SHOP_STEAL_COOLDOWN_SECONDS
        cm_msg("The shop owner turns their attention back to the chest. Choose your moment carefully.", HUE_BLUE)
        return

    # Never answer, close, cover, or otherwise interfere with the shard's
    # Escape/Fight consequence gump.
    shop_steal_ready_at = time.time() + SHOP_STEAL_COOLDOWN_SECONDS
    wait_for_consequence_gump(previous_gump)
...
def handle_main_screen():
    ...
    if button_id == 0:
        ...
        # Close Shop only after the controller handoff flag is confirmed.
        try:
            Misc.SetSharedValue("ChestLootPro_ReturnToModeSelection", 1)
            handoff_ready = int(Misc.ReadSharedValue("ChestLootPro_ReturnToModeSelection")) == 1
        except:
            handoff_ready = False
        if handoff_ready:
            close_all_test_gumps()
            ...
            cm_msg("The Mode Selection gump could not be opened. Please try again.", HUE_DISABLED)
            draw_main_gump()
    elif button_id == BTN_OPEN_OPTIONS:
        current_screen = "options"
        draw_options_gump()
    elif button_id == BTN_LEARN_RARE:
        record_shop_rare()
        draw_main_gump()
    elif button_id == BTN_STEAL_ITEM:
        steal_item()
        draw_main_gump()
    elif button_id == BTN_TARGET:
        run_shop_target()
...
def handle_list_screen():
    global current_screen, active_list_page
    button_id = get_button_id(LIST_GUMP_ID)
    if button_id is None:
        return
    if button_id in (0, BTN_LIST_BACK):
        current_screen = "options"
        active_list_page = 0
        draw_options_gump()
        return
    ...
    if button_id >= BTN_LIST_REMOVE_BASE:
        index = button_id - BTN_LIST_REMOVE_BASE
        if 0 <= index < len(shop_rare_items):
            removed = shop_rare_items.pop(index)
            cm_msg("{} has been removed from your Rare Shop Items list.".format(removed.get("name", "Unknown Item")), HUE_JOURNAL_OPTION)
            save_all()
        draw_list_gump()
...
def run():
    ...
    load_all(); active_profile=PROFILE_SHOP; close_all_test_gumps(); gump_closed=False; current_screen="main"
    # This standalone test enters Shop mode immediately. In the integrated
    # tool, call this when Shop mode opens rather than at full-tool startup.
    shop_rare_count_message()
    draw_main_gump()
    while not gump_closed:
